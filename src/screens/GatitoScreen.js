...
const createStyles = (colors) => StyleSheet.create({
  ...
  levelCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 18, borderRadius: RADII.lg, backgroundColor: colors.bgGlass, borderWidth: 1, borderColor: colors.border, marginBottom: 18, shadowColor: colors.pinkStrong, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.08, shadowRadius: 18 },
  ...
  achievementCard: { padding: 18, borderRadius: RADII.lg, backgroundColor: colors.bgGlass, borderWidth: 1, borderColor: colors.border, marginBottom: 18, shadowColor: colors.blueStrong, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.08, shadowRadius: 18 },
  ...
  illustrationCard: { flex: 1, padding: 14, borderRadius: RADII.lg, backgroundColor: colors.bgGlass, borderWidth: 1, borderColor: colors.border, minHeight: 168, shadowColor: colors.pinkStrong, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.08, shadowRadius: 16 },
  ...
  quickCard: { flex: 1.35, padding: 18, borderRadius: RADII.lg, backgroundColor: colors.bgGlass, borderWidth: 1, borderColor: colors.border, marginBottom: 18, shadowColor: colors.blueStrong, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.08, shadowRadius: 16 },
  quickActionRow: { flexDirection: 'row', gap: 12, marginTop: 8, marginBottom: 14 },
  quickActionButton: { flex: 1, padding: 14, borderRadius: RADII.md, backgroundColor: colors.bgGlassStrong, borderWidth: 1, borderColor: colors.border, shadowColor: colors.lilacStrong, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.08, shadowRadius: 14 },
  ...
  ritualCard: { flex: 1, padding: 18, borderRadius: RADII.lg, backgroundColor: `${colors.pink}12`, borderWidth: 1, borderColor: `${colors.pinkStrong}42`, marginBottom: 18, shadowColor: colors.pinkStrong, shadowOffset: { width: 0, height: 14 }, shadowOpacity: 0.12, shadowRadius: 18 },
