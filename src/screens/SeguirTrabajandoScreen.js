...
const createStyles = (colors) => StyleSheet.create({
  ...
  ritualGalleryTile: { flex: 1, height: 104, borderRadius: 18, backgroundColor: colors.bgGlass, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', shadowColor: colors.shadow, shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.1, shadowRadius: 16 },
  ritualGalleryImage: { width: '82%', height: '82%' },
  blocksGrid: { width: '100%' },
  blocksGridWide: { flexDirection: 'row', gap: 14, alignItems: 'stretch' },
  card: { flex: 1, padding: 18, borderRadius: 18, backgroundColor: colors.bgGlass, borderWidth: 1, borderColor: colors.border, marginBottom: 14, shadowColor: colors.shadow, shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.1, shadowRadius: 16 },
  ...
  reminderCard: { padding: 18, borderRadius: 18, backgroundColor: colors.bgGlass, borderWidth: 1, borderColor: colors.border, shadowColor: colors.shadow, shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.1, shadowRadius: 16 },
  ...
  ctaButton: { paddingVertical: 15, paddingHorizontal: 16, borderRadius: 16, backgroundColor: colors.lilacStrong, alignItems: 'center' },
  ctaButtonText: { color: colors.bg, fontSize: 13, fontWeight: '800' },
  ctaGhost: { paddingVertical: 14, paddingHorizontal: 16, borderRadius: 16, borderWidth: 1, borderColor: colors.borderStrong, backgroundColor: colors.bgGlass, alignItems: 'center' },
